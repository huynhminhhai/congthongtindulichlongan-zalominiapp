...
const MyApp = () => {
  ...
  useEffect(() => {
    const loadAuthData = async () => {
      try {
        const storedData =
          (await getDataFromStorage(['account', 'token', 'lng'])) || {} // Đảm bảo storedData luôn là object
        const language = storedData.lng ?? 'vi' // Dùng nullish coalescing (??) để tránh lỗi undefined

        await initI18n(language)
        setIsI18nInitialized(true)

        const storedAccount = storedData.account
          ? JSON.parse(storedData.account)
          : null
        const storedToken = storedData.token ?? null
          ...
          <SnackbarProvider>
            <ZMPRouter>
              ...
              <Routes>
                ...
                <Route
                  path="/cusine"
                  element={<CusinePage></CusinePage>}
                ></Route>
                <Route
                  path="/cusine-detail"
                  element={<CusineDetailPage></CusineDetailPage>}
                ></Route>
                ...
                <Route
                  path="/guide-detail"
                  element={<GuideDetailPage></GuideDetailPage>}
                ></Route>
                ...
                <Route
                  ...
                  element={<ShoppingDetailPage></ShoppingDetailPage>}
                ></Route>

                {/* MARKET */}
                <Route
                  path="/market"
                  element={<MarketPage></MarketPage>}
                ></Route>
                <Route
                  path="/market-detail"
                  element={<MarketDetailPage></MarketDetailPage>}
                ></Route>
                ...
                <Route
                  path="/bus-detail"
                  element={<BusDetailPage></BusDetailPage>}
                ></Route>
                ...
                <Route
                  path="/taxi-detail"
                  element={<TaxiDetailPage></TaxiDetailPage>}
                ></Route>
                ...
                <Route
                  path="/oil-detail"
                  element={<OilDetailPage></OilDetailPage>}
                ></Route>
                ...
                <Route
                  ...
                  element={<HospitalDetailPage></HospitalDetailPage>}
                ></Route>
                ...
                <Route
                  path="/atm-detail"
                  element={<AtmDetailPage></AtmDetailPage>}
                ></Route>

                {/* Bus routing */}
                <Route
                  path="/bus-routing"
                  element={<BusRoutingPage></BusRoutingPage>}
                ></Route>
                <Route
                  path="/bus-routing-detail"
                  element={<BusRoutingDetailPage></BusRoutingDetailPage>}
                ></Route>
                ...
                <Route
                  path="/gallery-detail"
                  element={<GalleryDetailPage></GalleryDetailPage>}
                ></Route>
                ...
                <Route
                  ...
                  element={<FeedbackDetailPage></FeedbackDetailPage>}
                ></Route>
                <Route
                  path="/feedback-add"
                  element={<FeedbackAddPage></FeedbackAddPage>}
                ></Route>
                <Route
                  path="/feedback-history"
                  element={<FeedbackHistoryPage></FeedbackHistoryPage>}
                ></Route>
                ...
                <Route
                  ...
                  element={<ProfileAccountPage></ProfileAccountPage>}
                ></Route>
                <Route
                ...
                <Route
                  path="/maps"
                  element={<ResidentMapPage></ResidentMapPage>}
                ></Route>

                {/* PROFILE */}
                <Route
                  path="/profile-resident"
                  element={<ProfileResidentPage></ProfileResidentPage>}
                ></Route>
