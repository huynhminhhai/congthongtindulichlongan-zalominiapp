...
export const cusineData = [
  {
    ...
    imgUrl:
      'https://cdn.buffetposeidon.com/app/media/uploaded-files/110724-lau-mam-mien-tay-cung-buffet-poseidon-1-1.jpg',
  },
  {
    ...
    imgUrl:
      'https://www.thatlangon.com/wp-content/uploads/2021/09/canh-chua-ca-tln1-e1633942511539.jpg',
  },
  {
    ...
    imgUrl:
      'https://cdn.tgdd.vn/Files/2022/11/18/1488658/gao-nang-thom-cho-dao-la-gi-mua-o-dau-gia-bao-nhieu-202211181548390865.jpg',
  },
  {
    ...
    imgUrl:
      'https://images.baoangiang.com.vn/image/media/2023/20231222/video/thumbnail/690x420/4299_img_1569.jpg',
  },
]
...
const CusineSection = () => {
  ...
  return (
    <Box pt={4} pb={6} pl={4} className="cusine-section">
      <Box pr={4}>
        <TitleSection
          title={t('cusine')}
          handleClick={() => navigate('/cusine')}
        />
      </Box>
      <Swiper
