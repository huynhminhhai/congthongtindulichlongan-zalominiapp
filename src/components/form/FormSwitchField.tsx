            ...
            <div className="relative h-full flex items-center justify-center gap-2">
                {[labelOff, labelOn].map((text, index) => {
                    ...
                    return (
                        <div
                            key={text}
                            className={`transition-all duration-300 w-full h-[30px] flex items-center justify-center rounded-full text-center text-[14px] leading-[1] font-medium ${isActive ? "text-white bg-[#355933]" : "text-[#355933]"
                                }`}
                        >
                            {text}
                        </div>
